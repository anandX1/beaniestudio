...
const cards = [
  ...
  },
  {
    ...
    lines: [
      { text: 'DEVLOG', scale: 10 },
      { text: 'BUILDING STATIC, PIECE BY PIECE', scale: 4 },
    ],
  },
  {
    file: 'press.png',
...
// Post cards are generated by the devlog page script via `node scripts/generate-og.mjs --posts`
// (kept in one place so the pixel font stays shared). See generate-post-og note in devlog page.
